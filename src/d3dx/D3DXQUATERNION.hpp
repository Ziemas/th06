 ...
 * @return
 */
static zD3DXQUATERNION *D3DXQuaternionIdentity(zD3DXQUATERNION *pOut)
{
    #ifdef D3DX_POINTER_CHECK
        if(!pOut) {
		    pOut = new zD3DXQUATERNION();
        }
    #endif
 ...
 * @return
 */
static zD3DXQUATERNION *D3DXQuaternionRotationAxis(zD3DXQUATERNION *pOut, const zD3DXVECTOR3 * pV, float Angle)
{
    #ifdef D3DX_POINTER_CHECK
        if(!pOut) {
		    pOut = new zD3DXQUATERNION();
 ...
 * @return
 */
static zD3DXQUATERNION *D3DXQuaternionRotationVec3toVec3(zD3DXQUATERNION *pOut, const zD3DXVECTOR3 * pV0, const zD3DXVECTOR3 * pV1)
{
    #ifdef D3DX_POINTER_CHECK
        if(!pOut) {
            pOut = new zD3DXQUATERNION();
    ...
    zD3DXVECTOR3 axis;
    zD3DXVec3Cross(&axis, pV0, pV1);

    float cosRot = zD3DXVec3Dot(pV0, pV1);
 ...
 * @return
 */
static inline float D3DXQuaternionDot(const zD3DXQUATERNION *pQ1, const zD3DXQUATERNION *pQ2)
{
    return (pQ1->x * pQ2->x +
            pQ1->y * pQ2->y +
            pQ1->z * pQ2->z +
 ...
 * @return
 */
static inline zD3DXQUATERNION* D3DXQuaternionSlerp(zD3DXQUATERNION *pOut, const zD3DXQUATERNION *pQ1, const zD3DXQUATERNION *pQ2, float t)
{
    #ifdef D3DX_POINTER_CHECK
        if(pOut) {
		    pOut = new zD3DXQUATERNION();
