...
* @return
*/
static zD3DXVECTOR2 *D3DXVecToAng(const zD3DXVECTOR3 *dir, zD3DXVECTOR2 *out)
{

#ifdef D3DX_POINTER_CHECK
    if(!out) {
        out = new zD3DXVECTOR2();
    }
#endif
...
* @return
*/
static zD3DXVECTOR2 *D3DXVecToTexCoord(const zD3DXVECTOR3 *dir, zD3DXVECTOR2 *pOut)
{
#ifdef D3DX_POINTER_CHECK
    if(!pOut) {
...
* @return
*/
static zD3DXVECTOR3 *D3DXAngToVec(const zD3DXVECTOR2 *dir, zD3DXVECTOR3 *out)
{
#ifdef D3DX_POINTER_CHECK
    if(!out) {
...
* @return
*/
static inline zD3DXVECTOR3 *D3DXImgCoordToVec(float x, float y, int width, int height, zD3DXVECTOR3 *pOut)
{
#ifdef D3DX_POINTER_CHECK
    if(!pOut) {
...
* @param v
*/
static void CreateOrthoNormalBase(const zD3DXVECTOR3 *n, zD3DXVECTOR3 *u, zD3DXVECTOR3 *v)
{
    ...
    zD3DXVec3Normalize(v);
    zD3DXVec3Cross(u, v, n);

    //NOTE: This should not be required
    zD3DXVec3Normalize(u);
}
...
* @return
*/
static zD3DXVECTOR3 *D3DXVecProjBase(const zD3DXVECTOR3 *V0,
                             const zD3DXVECTOR3 *V1,
                             const zD3DXVECTOR3 *V2,
                             const zD3DXVECTOR3 *pV,
                             zD3DXVECTOR3 *pOut)
{
#ifdef D3DX_POINTER_CHECK
    if(!pOut) {
    ...
    pOut->x = zD3DXVec3Dot(V0, pV);
    pOut->y = zD3DXVec3Dot(V1, pV);
    pOut->z = zD3DXVec3Dot(V2, pV);
...
* @return
*/
static zD3DXVECTOR3 *D3DXVecApplyBase(	const zD3DXVECTOR3 *V0,
                              const zD3DXVECTOR3 *V1,
                              const zD3DXVECTOR3 *V2,
                              const zD3DXVECTOR3 *pV,
                              zD3DXVECTOR3 *pOut)
...
* @param n
*/
static void DecompressNormals(zD3DXVECTOR3 *n)
{
...
* @return
*/
static zD3DXVECTOR3 *FibonacciNormals(zD3DXVECTOR3 *pOut, unsigned int j, float n_f)
{
#ifdef D3DX_POINTER_CHECK
    if(!pOut) {
        pOut = new zD3DXVECTOR3();
...
* @return
*/
static unsigned int FibonacciNormalsInv(const zD3DXVECTOR3 *pA, float n_f)
{
#ifdef D3DX_POINTER_CHECK
    if(!pA) {
        pA = new zD3DXVECTOR3();
    ...
    zD3DXMATRIX2X2 B = zD3DXMATRIX2X2(
    ...
    zD3DXMATRIX2X2 B_inv;
    B.Inverse(&B_inv);

    zD3DXVECTOR2 vec = zD3DXVECTOR2(phi, cosTheta - (1.0f - 1.0f / n_f));

    zD3DXVECTOR2 c = B_inv * vec;
    c.x = floorf(c.x);
    c.y = floorf(c.y);
    ...
    for(unsigned int k = 0; k < 4; k++) {
        ...
        zD3DXVECTOR2 tmp_v2 = zD3DXVECTOR2(float(k % 2), float(k / 2));
        tmp_v2 += c;
        float bias = (1.0f - n_f_rcp);
        float cosTheta = zD3DXVec2Dot(&B1, &tmp_v2) + bias;
        ...
        float dist_sq = zD3DXVecDistanceSq(&q, pA);
        if(dist_sq < d) {
            d = dist_sq;
            j = int(i);
        }
