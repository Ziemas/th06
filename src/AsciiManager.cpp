...
void AsciiManager::AddString(zVec3 *position, char *text)
{
...
void AsciiManager::AddFormatText(zVec3 *position, const char *fmt, ...)
{
    char tmpBuffer[512];
    va_list args;
...
void AsciiManager::CreatePopup1(zVec3 *position, i32 value, ZunColor color)
{
...
void AsciiManager::CreatePopup2(zVec3 *position, i32 value, ZunColor color)
{
    AsciiManagerPopup *popup;
    i32 characterCount;
...
i32 StageMenu::OnUpdateGameMenu()
{
    ...
    case GAME_MENU_PAUSE_CURSOR_UNPAUSE:
        ...
        this->menuSprites[GAME_MENU_SPRITE_CURSOR_UNPAUSE].posOffset = zVec3(-4.0f, -4.0f, 0.0f);
        this->menuSprites[GAME_MENU_SPRITE_CURSOR_QUIT].posOffset = zVec3(0.0f, 0.0f, 0.0f);
        if (4 <= this->numFrames)
        {
    ...
    case GAME_MENU_PAUSE_CURSOR_QUIT:
        ...
        this->menuSprites[GAME_MENU_SPRITE_CURSOR_UNPAUSE].posOffset = zVec3(0.0f, 0.0f, 0.0f);
        this->menuSprites[GAME_MENU_SPRITE_CURSOR_QUIT].posOffset = zVec3(-4.0f, -4.0f, 0.0f);
        if (4 <= this->numFrames)
        {
            if (WAS_PRESSED(TH_BUTTON_UP) || WAS_PRESSED(TH_BUTTON_DOWN))
            {
    ...
    case GAME_MENU_QUIT_CURSOR_YES:
        ...
        this->menuSprites[GAME_MENU_SPRITE_CURSOR_YES].posOffset = zVec3(-4.0f, -4.0f, 0.0f);
        this->menuSprites[GAME_MENU_SPRITE_CURSOR_NO].posOffset = zVec3(0.0f, 0.0f, 0.0f);
        if (4 <= this->numFrames)
        {
            if (WAS_PRESSED(TH_BUTTON_UP) || WAS_PRESSED(TH_BUTTON_DOWN))
            {
    ...
    case GAME_MENU_QUIT_CURSOR_NO:
        ...
        this->menuSprites[GAME_MENU_SPRITE_CURSOR_YES].posOffset = zVec3(0.0f, 0.0f, 0.0f);
        this->menuSprites[GAME_MENU_SPRITE_CURSOR_NO].posOffset = zVec3(-4.0f, -4.0f, 0.0f);
...
i32 StageMenu::OnUpdateRetryMenu()
{
    ...
    case RETRY_MENU_CURSOR_YES:
        ...
        this->menuSprites[RETRY_MENU_SPRITE_YES].posOffset = zVec3(-4.0f, -4.0f, 0.0f);
        this->menuSprites[RETRY_MENU_SPRITE_NO].posOffset = zVec3(0.0f, 0.0f, 0.0f);
        if (4 <= this->numFrames)
        {
            if (WAS_PRESSED(TH_BUTTON_UP) || WAS_PRESSED(TH_BUTTON_DOWN))
            {
    ...
    case RETRY_MENU_CURSOR_NO:
        ...
        this->menuSprites[RETRY_MENU_SPRITE_NO].posOffset = zVec3(-4.0f, -4.0f, 0.0f);
        this->menuSprites[RETRY_MENU_SPRITE_YES].posOffset = zVec3(0.0f, 0.0f, 0.0f);
